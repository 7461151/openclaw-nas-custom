...
RUN rm -f /usr/local/bin/gemini \
 ...
 && chmod +x /usr/local/bin/gemini /usr/local/bin/lp /usr/local/bin/print-entrypoint.sh /usr/local/bin/patch-qqbot-c2c-direct-session.py /usr/local/bin/patch-qqbot-delivery-mirror-session.py /usr/local/bin/patch-qqbot-outbound-mirror-route.py /usr/local/bin/patch-control-ui-delivery-model.py /usr/local/bin/patch-gemini-cli-provider-refresh.py /usr/local/bin/reconcile-qqbot-c2c-legacy-sessions.py /usr/local/bin/sync-gemini-cli-auth.py
